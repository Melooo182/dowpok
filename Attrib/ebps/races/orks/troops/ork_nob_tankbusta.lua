----------------------------------------
-- File: 'ebps\races\orks\troops\ork_nob_retinue.lua'
...
GameData["combat_ext"]["hardpoints"]["hardpoint_02"]["weapon_table"]["weapon_01"]["weapon"] = "weapon\\ork_power_claw_nob_leader.lua"
