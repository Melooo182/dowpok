----------------------------------------
-- File: 'ebps\races\space_marines\troops\force_commander_assault_advance_sp.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[ebps\races\space_marines\troops\force_commander_assault.lua]])
MetaData = InheritMeta([[ebps\races\space_marines\troops\force_commander_assault.lua]])
