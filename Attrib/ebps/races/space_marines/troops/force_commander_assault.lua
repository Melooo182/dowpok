----------------------------------------
-- File: 'ebps\races\space_marines\troops\force_commander_assault.lua'
...
--GameData["entity_blueprint_ext"]["animator"] = "Races/Space_Marines/Troops/force_commander_codex"
