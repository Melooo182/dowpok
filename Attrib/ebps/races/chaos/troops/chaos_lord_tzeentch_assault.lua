...
GameData = Inherit([[ebps\races\chaos\troops\chaos_lord_tzeentch.lua]])
MetaData = InheritMeta([[ebps\races\chaos\troops\chaos_lord_tzeentch.lua]])


GameData["spawner_ext"]["squad_table"]["squad_01"] = ""
GameData["addon_ext"]["addons"]["addon_09"] = ""
GameData["ability_ext"]["abilities"]["ability_11"] = "chaos_daemonic_essence_visual"
