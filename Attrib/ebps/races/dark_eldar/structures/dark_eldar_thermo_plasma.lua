----------------------------------------
-- File: 'ebps\races\dark_eldar\structures\dark_eldar_thermo_plasma.lua'
...
--GameData["ability_ext"]["abilities"]["ability_02"] = "abilities\\ability_enable_buildings_aura.lua"
