...
GameData = Inherit([[ebps\races\guard\troops\guard_infantry_kasrkin_airborne.lua]])
MetaData = InheritMeta([[ebps\races\guard\troops\guard_infantry_kasrkin_airborne.lua]])
