...
GameData["addon_ext"]["addons"]["addon_01"] = "addons\\guard_ai_lascannon_guardsmen.lua"

GameData["ability_ext"]["abilities"]["ability_01"] = "abilities\\guard_hwt_lascannon_upgrade.lua"
