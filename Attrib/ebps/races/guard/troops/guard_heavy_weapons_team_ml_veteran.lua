...
GameData = Inherit([[ebps\races\guard\troops\guard_heavy_weapons_team_ml.lua]])
MetaData = InheritMeta([[ebps\races\guard\troops\guard_heavy_weapons_team_ml.lua]])

GameData["ability_ext"]["abilities"]["ability_07"] = "abilities\\guard_cameleoline.lua"
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = "weapon\\guard_missile_launcher_heavy_weapons_team_veteran.lua"
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_02"]["weapon"] = "weapon\\guard_lascannon_heavy_weapons_team_veteran.lua"
