...
GameData["deep_strike_ext"]["deep_strike_object_name"] = "valkyrie_drop_airborne"
...
GameData["entity_blueprint_ext"]["animator"] = "Races/Imperial_guard/Troops/valkyrie_kasrkin_drop"
