...
GameData = Inherit([[ebps\races\guard\troops\guard_heavy_weapons_team_mortar.lua]])
MetaData = InheritMeta([[ebps\races\guard\troops\guard_heavy_weapons_team_mortar.lua]])

GameData["ability_ext"]["abilities"]["ability_07"] = "abilities\\guard_cameleoline.lua"
GameData["combat_ext"]["hardpoints"]["hardpoint_01"]["weapon_table"]["weapon_01"]["weapon"] = "weapon\\guard_mortar_veteran.lua"
