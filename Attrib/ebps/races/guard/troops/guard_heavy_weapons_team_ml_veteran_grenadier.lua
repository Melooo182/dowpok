...
GameData = Inherit([[ebps\races\guard\troops\guard_heavy_weapons_team_ml_veteran.lua]])
MetaData = InheritMeta([[ebps\races\guard\troops\guard_heavy_weapons_team_ml_veteran.lua]])
