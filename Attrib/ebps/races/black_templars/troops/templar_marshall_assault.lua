----------------------------------------
-- File: 'ebps\races\black_templars\troops\templar_marshall_assault.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[ebps\races\black_templars\troops\templar_marshall.lua]])
MetaData = InheritMeta([[ebps\races\black_templars\troops\templar_marshall.lua]])
