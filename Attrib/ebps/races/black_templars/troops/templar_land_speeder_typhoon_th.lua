...
GameData = Inherit([[ebps\races\space_marines\troops\land_speeder_typhoon_th.lua]])
MetaData = InheritMeta([[ebps\races\space_marines\troops\land_speeder_typhoon_th.lua]])
