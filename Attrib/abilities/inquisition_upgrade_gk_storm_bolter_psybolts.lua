...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\default_weapon_modifier_hardpoint5.lua]])
...
GameData["ui_info"]["screen_name_id"] = "$65000450"
