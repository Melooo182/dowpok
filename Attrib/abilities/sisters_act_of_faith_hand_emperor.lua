----------------------------------------
-- File: 'abilities\sisters_act_of_faith_hand_emperor.lua'
...
GameData["child_ability_name"] = "sisters_act_of_faith_hand_emperor_chid"
...
GameData["ui_info"]["screen_name_id"] = "Hand of the Emperor"
