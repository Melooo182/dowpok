...
GameData = Inherit([[abilities\inquisition_inquisitor_scourging.lua]])
MetaData = InheritMeta([[abilities\inquisition_inquisitor_scourging.lua]])

GameData["backfire_percent"] = 0.0000
GameData["child_ability_name"] = "inquisition_inquisitor_scourging3"
