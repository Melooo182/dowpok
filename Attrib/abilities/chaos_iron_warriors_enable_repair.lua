----------------------------------------
-- File: 'abilities\chaos_iron_warriors_enable_repair.lua'
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\enable_can_repair.lua]])
