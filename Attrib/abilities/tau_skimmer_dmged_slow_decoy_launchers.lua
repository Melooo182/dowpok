...
GameData = Inherit([[abilities\tau_skimmer_dmged_slow.lua]])
MetaData = InheritMeta([[abilities\tau_skimmer_dmged_slow.lua]])
...
GameData["requirements"]["required_2"]["addon_name"] = "addons\\tau_decoy_launchers_upgrade.lua"
