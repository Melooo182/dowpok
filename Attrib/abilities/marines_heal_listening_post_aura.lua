----------------------------------------
-- File: 'abilities\marines_heal_listening_post_aura.lua'
...
GameData["requirements"]["required_1"]["research_name"] = "research\\marine_reinforce_point_fortification_research.lua"
