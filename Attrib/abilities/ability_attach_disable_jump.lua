----------------------------------------
-- File: 'abilities\ability_attach_disable_jump.lua'
...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_02"] = Reference([[type_armour\tp_invuln_2_3.lua]])
