...
GameData["requirements"]["required_10"]["structure_name"] = "ebps\\races\\orks\\structures\\ork_generator.lua"
...
GameData["ui_info"]["icon_name"] = "ork_icons/power_inc_research_1"
