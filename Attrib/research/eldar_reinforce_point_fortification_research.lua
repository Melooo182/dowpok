...
GameData["requirements"]["required_2"]["structure_name"] = "ebps\\races\\eldar\\structures\\eldar_listening_post.lua"
...
GameData["ui_info"]["icon_name"] = "eldar_icons/research_medic_listening_post"
