...
GameData["requirements"]["required_2"]["structure_name"] = "ebps\\races\\chaos\\structures\\chaos_listening_post.lua"
...
GameData["ui_info"]["icon_name"] = "chaos_icons/research_medic_listening_post"
