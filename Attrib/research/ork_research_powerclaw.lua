...
GameData = Inherit([[research\ork_research_big_choppas.lua]])
MetaData = InheritMeta([[research\ork_research_big_choppas.lua]])

GameData["requirements"]["required_10"]["is_display_requirement"] = false
GameData["requirements"]["required_11"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_11"]["is_display_requirement"] = true
GameData["requirements"]["required_11"]["research_name"] = "research\\ork_research_big_choppas.lua"
GameData["requirements"]["required_12"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_12"]["research_name"] = "research\\ork_research_big_choppas.lua"
...
GameData["ui_info"]["icon_name"] = "ork_icons/research_powerclaw_icon_troops"
GameData["ui_info"]["screen_name_id"] = "Wargear: Power Klaws (Troops)"
