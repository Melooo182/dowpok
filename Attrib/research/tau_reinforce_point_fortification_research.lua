...
GameData["requirements"]["required_2"]["structure_name"] = "ebps\\races\\tau\\structures\\tau_listening_post.lua"
...
GameData["ui_info"]["icon_name"] = "tau_icons/research_medic_listening_post"
