...
GameData = Inherit([[addons\marine_librarian_gate_of_infinity.lua]])
MetaData = InheritMeta([[addons\marine_librarian_gate_of_infinity.lua]])
...
GameData["ui_index_hint"] = 35.00000
GameData["ui_info"]["help_text_list"]["text_01"] = "$61000815"
