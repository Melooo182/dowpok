...
GameData["requirements"]["required_3"]["addon_name"] = "addons\\addon_dark_eldar_hq_2.lua"
GameData["requirements"]["required_4"]["global_mutually_exclusive_with"] = "addons\\addon_dark_eldar_hq_3.lua"
