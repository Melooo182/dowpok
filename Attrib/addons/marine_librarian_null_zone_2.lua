...
GameData = Inherit([[addons\marine_librarian_null_zone.lua]])
MetaData = InheritMeta([[addons\marine_librarian_null_zone.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$61000819"
