...
GameData = Inherit([[addons\marine_librarian_might_of_heroes.lua]])
MetaData = InheritMeta([[addons\marine_librarian_might_of_heroes.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$61000817"
