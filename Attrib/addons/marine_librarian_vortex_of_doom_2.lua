...
GameData = Inherit([[addons\marine_librarian_vortex_of_doom.lua]])
MetaData = InheritMeta([[addons\marine_librarian_vortex_of_doom.lua]])
...
GameData["ui_index_hint"] = 34.00000
GameData["ui_info"]["help_text_list"]["text_01"] = "$61000823"
