----------------------------------------
-- File: 'research\guard_chimera_turret_heavy_bolter_upgrade.lua'
...
GameData["requirements"]["required_2"]["mutually_exclusive_with"] = "addons\\guard_chimera_turret_heavy_flamer_upgrade.lua"
