...
--GameData["requirements"]["required_2"]["global_mutually_exclusive_with"] = "addons\\black_marine_hq_medic.lua"
...
GameData["ui_info"]["icon_name"] = "black_templar_icons/research_medic_hq"
