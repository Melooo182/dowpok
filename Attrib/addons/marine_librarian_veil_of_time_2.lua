...
GameData = Inherit([[addons\marine_librarian_veil_of_time.lua]])
MetaData = InheritMeta([[addons\marine_librarian_veil_of_time.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$61000821"
