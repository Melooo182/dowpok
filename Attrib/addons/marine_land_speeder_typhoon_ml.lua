----------------------------------------
-- File: 'research\marine_land_speeder_typhoon_ml.lua'
...
GameData["requirements"]["required_3"]["mutually_exclusive_with"] = "addons\\marine_land_speeder_assault_cannon.lua"
