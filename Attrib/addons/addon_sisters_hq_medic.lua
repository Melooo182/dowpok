...
--GameData["requirements"]["required_2"]["global_mutually_exclusive_with"] = "addons\\addon_sisters_hq_medic.lua"
...
GameData["ui_info"]["icon_name"] = "guard_icons/research_medic_hq"
