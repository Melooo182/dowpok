----------------------------------------
-- File: 'research\eldar_falcon_upgrade_1.lua'
...
GameData["requirements"]["required_11"]["mutually_exclusive_with"] = "addons\\eldar_falcon_upgrade_2.lua"
