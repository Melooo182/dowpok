...
GameData = Inherit([[addons\addon_eldar.nil]])
MetaData = InheritMeta([[addons\addon_eldar.nil]])
...
--GameData["requirements"]["required_2"]["global_mutually_exclusive_with"] = "addons\\eldar_hq_medic.lua"
...
GameData["ui_info"]["icon_name"] = "eldar_icons/research_medic_hq"
