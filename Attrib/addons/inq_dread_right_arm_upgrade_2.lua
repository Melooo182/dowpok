...
GameData["requirements"]["required_11"]["mutually_exclusive_with"] = "addons\\inq_dread_right_arm_upgrade_1.lua"
...
GameData["ui_info"]["icon_name"] = "guard_icons/inq_dread_assaultcannon"
