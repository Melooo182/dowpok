...
GameData["requirements"]["required_13"]["mutually_exclusive_with"] = "addons\\templar_bionics_marshall.lua"
GameData["requirements"]["required_14"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_14"]["mutually_exclusive_with"] = "addons\\templar_terminator_honours_marshall.lua"
