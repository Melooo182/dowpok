...
--Right Arm built in Heavy Flamer
...
GameData["requirements"]["required_11"]["mutually_exclusive_with"] = "addons\\marine_dread_iron_right_arm_upgrade_2.lua"
...
GameData["ui_info"]["help_text_list"]["text_01"] = "$61000978"
