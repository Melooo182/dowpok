...
GameData["requirements"]["required_11"]["mutually_exclusive_with"] = "addons\\templar_storm_shield_castellan.lua"
GameData["requirements"]["required_12"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_12"]["mutually_exclusive_with"] = "addons\\templar_jump_pack_castellan.lua"
