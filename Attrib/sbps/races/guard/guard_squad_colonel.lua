----------------------------------------
-- File: 'sbps\races\guard\guard_squad_colonel.lua'
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = "research\\guard_doctrine_infantry.lua"
