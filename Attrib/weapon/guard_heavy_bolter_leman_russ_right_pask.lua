----------------------------------------
-- File: 'weapon\guard_heavy_bolter_leman_russ_right_ace.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\guard_heavy_bolter_leman_russ_right.lua]])
MetaData = InheritMeta([[weapon\guard_heavy_bolter_leman_russ_right.lua]])
