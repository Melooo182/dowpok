----------------------------------------
-- File: 'weapon\ork_snazzgun_shootier_blasta_flash_gitz.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\ork_snazzgun_shootier_flash_gitz.lua]])
MetaData = InheritMeta([[weapon\ork_snazzgun_shootier_flash_gitz.lua]])
