----------------------------------------
-- File: 'weapon\chaos_daemon_weapon_bloodfeeder.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\chaos_daemon_weapon_bloodfeeder.lua]])
MetaData = InheritMeta([[weapon\chaos_daemon_weapon_bloodfeeder.lua]])
