----------------------------------------
-- File: 'weapon\dark_eldar_impaler_wych_nodmg_slowing.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\dark_eldar_impaler_wych.lua]])
MetaData = InheritMeta([[weapon\dark_eldar_impaler_wych.lua]])
