----------------------------------------
-- File: 'weapon\dark_eldar_hellglaive.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\dark_eldar_sword.nil]])
MetaData = InheritMeta([[weapon\dark_eldar_sword.nil]])
...
MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 585500, rangeEnd = 585549, }
