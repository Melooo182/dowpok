----------------------------------------
-- File: 'weapon\chaos_lightning_claws_chosen.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\chaos_lightning_claws_dual_lord_khorne.lua]])
MetaData = InheritMeta([[weapon\chaos_lightning_claws_dual_lord_khorne.lua]])
