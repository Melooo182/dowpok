----------------------------------------
-- File: 'weapon\guard_flamer_leman_russ_right.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\guard_heavy_flamer_leman_russ_right.lua]])
MetaData = InheritMeta([[weapon\guard_heavy_flamer_leman_russ_right.lua]])
...
--Dmg 1,5x
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 37.50000
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 18.75000
