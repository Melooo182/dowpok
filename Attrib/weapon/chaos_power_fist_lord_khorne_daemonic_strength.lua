----------------------------------------
-- File: 'weapon\chaos_power_fist_lord.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\chaos_power_fist_lord_khorne.lua]])
MetaData = InheritMeta([[weapon\chaos_power_fist_lord_khorne.lua]])
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["max_damage"] = 180.00000 -- 2x
--Initiative 1 90x0.1=9
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 18.00000 --2x
