----------------------------------------
-- File: 'weapon\space_marine_heavy_flamer_land_speeder.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\templar_heavy_flamer_terminator.lua]])
MetaData = InheritMeta([[weapon\templar_heavy_flamer_terminator.lua]])
