----------------------------------------
-- File: 'weapon\chaos_power_sword_lord_blissgiver.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\chaos_daemon_weapon_blissgiver.lua]])
MetaData = InheritMeta([[weapon\chaos_daemon_weapon_blissgiver.lua]])
