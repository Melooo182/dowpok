----------------------------------------
-- File: 'weapon\eldar_chainsword_scorpion.lua'
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_23"]["armour_piercing_value"] = 5.00000 -- AP- rule of -10
