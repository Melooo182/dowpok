...
GameData = Inherit([[weapon\inquisition_storm_bolter_gk_terminator_leader.lua]])
MetaData = InheritMeta([[weapon\inquisition_storm_bolter_gk_terminator_leader.lua]])
