----------------------------------------
-- File: 'weapon\chaos_power_sword_sorcerer_force_weapon.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\chaos_power_sword_sorcerer.lua]])
MetaData = InheritMeta([[weapon\chaos_power_sword_sorcerer.lua]])
