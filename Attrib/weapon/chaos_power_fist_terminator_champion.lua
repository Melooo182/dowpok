----------------------------------------
-- File: 'weapon\chaos_power_fist_terminator.lua'
-- Created by: AttributeEditor v2.0
-- Note: Do NOT edit by hand!
-- (c) 2001 Relic Entertainment Inc.

GameData = Inherit([[weapon\chaos_power_fist_terminator.lua]])
MetaData = InheritMeta([[weapon\chaos_power_fist_terminator.lua]])
