...
GameData = Inherit([[weapon\templar_chainfist_terminator.lua]])
MetaData = InheritMeta([[weapon\templar_chainfist_terminator.lua]])

--Tank Hunters +1 to vehicle armour pen
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_28"]["armour_piercing_value"] = 90.00000
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_15"]["armour_piercing_value"] = 90.00000
